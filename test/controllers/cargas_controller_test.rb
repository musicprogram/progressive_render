...
class CargasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carga" do
    assert_difference('Carga.count') do
      post cargas_url, params: { carga: { description: @carga.description, name: @carga.name } }
    end
  ...
  test "should update carga" do
    patch carga_url(@carga), params: { carga: { description: @carga.description, name: @carga.name } }
